...
public class MyDailogFragment extends AppCompatDialogFragment  {

    public static MyDailogFragment newInstance(String title,String comments,String cancel,String sure)
    {
        MyDailogFragment fragment = new MyDailogFragment();
