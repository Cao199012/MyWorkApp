...
public class MyDialogFragment extends AppCompatDialogFragment  {
    ...
    public static MyDialogFragment newInstance(String title, String comments, String cancel, String sure)
    {
    ...
    public void setListener(FragmentDialogListener listrner) {
        this.mListrner = listrner;
    }
