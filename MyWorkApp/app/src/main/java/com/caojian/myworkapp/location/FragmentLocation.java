...
import static com.caojian.myworkapp.location.LocationDetailActivity.go2LocationDetailActivity;
...
//显示InfoWindow
               Marker marker = (Marker) baiduMap.addOverlay(options);
                ...
                baiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(Marker marker) {
                        ...
                        InfoWindow mInfoWindow = new InfoWindow(textView, marker.getPosition(), -47);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            go2LocationDetailActivity(getActivity());
            return true;
        }
