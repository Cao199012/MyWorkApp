...
public abstract class BaseNoProgressObserver<T> implements Observer<T> {
    ...
    int mGetType = 0; //0 gengxin 1 不更新
    public BaseNoProgressObserver(BaseTitleActivity activity, BasePresenter presenter,int pGetType){
    ...
    public void onNext( T t) {
        ...
        }else if(baseResponseResult.getCode() == 4  || baseResponseResult.getCode() == 5 && mGetType == 0){
